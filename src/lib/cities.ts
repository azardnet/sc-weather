import type { CityImageMeta, CityVideoMeta } from "./types";

export const CITY_HAVE_IMAGE: CityImageMeta[] = [
  {
    name: "liverpool",
    id: 2644210,
    images: [
      { photographer: "Neil Martin", link: "https://unsplash.com/@anagoge" },
      { photographer: "Fleur", link: "https://unsplash.com/@yer_a_wizard" },
      { photographer: "Phil Kiel", link: "https://unsplash.com/@pk_drone" },
    ],
  },
  {
    name: "ahvāz",
    ...
    images: [
      ...
      { photographer: "ariyan Dv", link: "https://unsplash.com/@ariyandv" },
    ],
  },
  {
    name: "tehran",
    ...
    images: [
      ...
      { photographer: "Omid Armin", link: "https://unsplash.com/@omidarmin" },
    ],
  },
  {
    name: "āmol",
  ...
  },
  {
    name: "Dubai",
    id: 292223,
    images: [{ photographer: "ZQ Lee", link: "https://unsplash.com/@zqlee" }],
  },
  {
    name: "Yerevan",
    id: 616052,
  ...
  },
  {
    name: "Washington D.C.",
    id: 4140963,
    images: [{ photographer: "Duane Lempke", link: "" }],
  },
  {
    name: "Strasbourg",
    id: 2973783,
...
export const CITY_HAVE_VIDEO: CityVideoMeta[] = [
  {
    name: "liverpool",
    id: 2644210,
    videos: [
